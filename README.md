...
Train small, insanely fast local classifiers from Jev-compatible examples that can run iun the browser. One npm package includes the training CLI, Node.js SDK, and browser SDK.
